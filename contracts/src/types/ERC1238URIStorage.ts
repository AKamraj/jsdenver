...
export interface ERC1238URIStorageInterface extends utils.Interface {
  functions: {
...
export interface ERC1238URIStorage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC1238URIStorageInterface;
