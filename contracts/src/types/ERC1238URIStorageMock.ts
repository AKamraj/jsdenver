...
export interface ERC1238URIStorageMockInterface extends utils.Interface {
  functions: {
    "DOMAIN_SEPARATOR()": FunctionFragment;
    "balanceOf(address,uint256)": FunctionFragment;
    "balanceOfBatch(address,uint256[])": FunctionFragment;
    "balanceOfBundle(address[],uint256[][])": FunctionFragment;
    "burnAndDeleteURI(address,uint256,uint256)": FunctionFragment;
    "burnBatchAndDeleteURIs(address,uint256[],uint256[])": FunctionFragment;
    "deleteTokenURI(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "burnAndDeleteURI",
    values: [string, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "burnBatchAndDeleteURIs",
    values: [string, BigNumberish[], BigNumberish[]]
  ): string;
  encodeFunctionData(
    functionFragment: "deleteTokenURI",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface ERC1238URIStorageMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC1238URIStorageMockInterface;
  ...
  callStatic: {
    ...
    deleteTokenURI(id: BigNumberish, overrides?: CallOverrides): Promise<void>;
