...
export interface IERC1238ReceiverInterface extends utils.Interface {
  functions: {
...
export interface IERC1238Receiver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IERC1238ReceiverInterface;
